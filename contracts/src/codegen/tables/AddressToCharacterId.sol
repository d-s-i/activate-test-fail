...
library AddressToCharacterId {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "dreamin", name: "AddressToCharact", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462647265616d696e0000000000000041646472657373546f43686172616374);
   ...
   */
  function getCharacterId(address player) internal view returns (uint256 characterId) {
   ...
   * @notice Get characterId.
   */
  function _getCharacterId(address player) internal view returns (uint256 characterId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get characterId.
   */
  function get(address player) internal view returns (uint256 characterId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get characterId.
   */
  function _get(address player) internal view returns (uint256 characterId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   */
  function setCharacterId(address player, uint256 characterId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set characterId.
   */
  function _setCharacterId(address player, uint256 characterId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set characterId.
   */
  function set(address player, uint256 characterId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set characterId.
   */
  function _set(address player, uint256 characterId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
